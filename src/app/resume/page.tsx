...
//                 className="text-3xl text-center font-bold tracking-tighter mb-4 sm:text-5xl xl:text-6xl/none"
//                 yOffset={8}
//                 text="Olibhia Ghosh"
//               />
//           <BlurFadeText
...
//                 yOffset={8}
//                 text="A Full Stack developer, freelance technical writer and open source contributor"
//               />
    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-12 text-center flex flex-col items-center">
          <BlurFadeText
            delay={BLUR_FADE_DELAY}
            className="mb-3 text-4xl lg:text-5xl font-bold tracking-tight text-foreground"
            yOffset={8}
            text="Olibhia Ghosh"
          />
          <BlurFadeText
        ...
        <section>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 19}>
            <Card className="bg-resume_card">
              <CardContent className="p-6">
                <div className="flex flex-wrap gap-2">
                  {["English", "Hindi", "Bengali"].map((lang, id) => (
                    <BlurFade key={lang} delay={BLUR_FADE_DELAY * 20 + id * 0.05}>
                      <SkillBadge>{lang}</SkillBadge>
                    </BlurFade>
                  ))}
                </div>
              </CardContent>
